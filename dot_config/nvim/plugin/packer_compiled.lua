...
_G.packer_plugins = {
  ["auto-pairs"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/auto-pairs",
    url = "https://github.com/jiangmiao/auto-pairs"
  },
  ["coc-nvim-lua"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/coc-nvim-lua",
    url = "https://github.com/rafcamlet/coc-nvim-lua"
  },
  ["coc.nvim"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/coc.nvim",
    url = "https://github.com/neoclide/coc.nvim"
  },
  ["completion-nvim"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/completion-nvim",
  ...
  ["tex-conceal.vim"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/tex-conceal.vim",
  ...
  ultisnips = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/ultisnips",
    url = "https://github.com//SirVer/ultisnips"
  },
  ["vim-snippets"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/vim-snippets",
    url = "https://github.com/honza/vim-snippets"
  },
  ["vim-surround"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/vim-surround",
    url = "https://github.com/tpope/vim-surround"
  },
  vimtex = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/vimtex",
